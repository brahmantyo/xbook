...
class Money{
     ...
     */
    public function __construct($symbol="Rp",$decimal=0,$vat=0.1,$decimalPoint=",",$thousandSeparator=".") {
        // Set VAT
        $this->vat = $vat;   
    ...
    public function format($input) {
        ...
        return number_format(round($input, 2), $this->decimal, $this->decimalPoint, $this->thousandSeparator);
    }
    /**
     * VAT
     *
